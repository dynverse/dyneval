...
#'
#' @param object output as generated by \code{\link{plotdata_default}}, \code{\link{wrap_ti_task_data}} or \code{\link{wrap_ti_prediction}}
#' @param insert_phantom_edges attempt to plot bifurcating edges correctly automatically
#'
#' @import ggplot2
...
#' Plot a dimensionality reduced trajectory
#'
#' @param original_object output as generated by \code{\link{plotdata_default}}, \code{\link{wrap_ti_task_data}} or \code{\link{wrap_ti_prediction}}
#' @param new_object output as generated by \code{\link{plotdata_default}}, \code{\link{wrap_ti_task_data}} or \code{\link{wrap_ti_prediction}}
#' @param insert_phantom_edges attempt to plot bifurcating edges correctly automatically
#'
#' @import ggplot2
#' @importFrom grid arrow
...
#' @param dimred the dimensionality reduction of the trajectory as produced by \code{\link{plotdata_default}}
#' @export
#'
