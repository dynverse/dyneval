...
#'
#' @export
plotLearner.ti.combined <- function(original_object, new_object, insert_phantom_edges = T) {
  if (dyneval:::is_ti_wrapper(original_object)) {
    original_dimred <- dyneval:::plotLearnerData.ti.default(original_object, insert_phantom_edges = insert_phantom_edges)
  } else if (dyneval:::is_ti_dimred_wrapper(original_object)) {
  ...
  if (dyneval:::is_ti_wrapper(new_object)) {
    new_dimred <- dyneval:::plotLearnerData.ti.default(new_object, insert_phantom_edges = insert_phantom_edges)
  } else if (dyneval:::is_ti_dimred_wrapper(new_object)) {
