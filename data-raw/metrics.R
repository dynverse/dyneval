...
metrics <- tribble(
  ...
  "rf_nmse", "NMSE[rf]", "\\mathit{NMSE}_{\\textit{rf}}", "Random Forest MSE", "neighbourhood", 1, 0,
  "rf_mse", "MSE[rf]", "\\mathit{MSE}_{\\textit{rf}}", "Random Forest Normalised MSE", "neighbourhood", 0, 0.3,
  "rf_rsq", "R[rf]^2", "R^{2}_{rf}", "Random Forest R²", "neighbourhood", 1, 0,
  "lm_nmse", "NMSE[lm]", "\\mathit{NMSE}_{\\textit{lm}}", "Linear regression Normalised MSE", "neighbourhood", 1, 0,
  ...
  "F1_milestones", "F1[milestones]", "\\mathit{F1}_{\\textit{milestones}}", "Overlap between the milestones", "branches", 1, 0,
  "harm_mean", "h-mean", "\\textrm{h-mean}", "Harmonic mean", "average", 1, 0
)
